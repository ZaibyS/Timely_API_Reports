    ...
    if response.status_code == 200:
        ...
        for project_id in client_project_pairs:
            ...
            if response_second_request.status_code == 200:
                ...
                file_path_second_request = os.path.join(date_folder, f'reports_{date}_{project_id}.json')
        ...
        file_path_first_request = os.path.join(date_folder, f'reports_{date}_all.json')
