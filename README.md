In the extracted data from the API, the number of rows exceeds that of the provided sample file. This variance can be attributed to the following reasons:
